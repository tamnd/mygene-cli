...
Most of these come down to network reality or how mygene serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

mygene rate-limits like any public site. mygene already paces
...
Where a surface is gated, mygene reads a cookie or token you supply
...
`mygene`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what mygene actually did
