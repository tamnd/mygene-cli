...
// HTTP behaviour is covered in mygene_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "mygene://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("mygene", "about")
	if err != nil || got.String() != "mygene://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want mygene://page/about", got.String(), err)
	}
}
